...
export const translations = {
  zh: {
    ...
    moseyTitle: 'MOSEY',
    moseySubtitle: '2030 未来驾驶体验设计',
    cubesFootbridgeTitle: 'Cubes of Growth',
    cubesFootbridgeSubtitle: '基于生长算法的人行桥设计',
    fluxorTitle: 'Fluxor',
    fluxorSubtitle: '2040 上海出行系统设计',
    ingeniousSkinTitle: 'Ingenious Skin',
    ingeniousSkinSubtitle: '基于智能织物的智能座舱自然交互设计',
    scienceExhibitionTitle: 'Science Popularization Exhibition',
    scienceExhibitionSubtitle: '科普展览交互与视觉设计',
    helmetGenerativeTitle: 'Helmet Generative Design',
    helmetGenerativeSubtitle: '基于生成式设计的骑行头盔概念',
  },
  en: {
    // Header
    siteName: 'MAOSHUO CHEN',
    ...
    moseyTitle: 'MOSEY',
    moseySubtitle: '2030 Future Driving Experience Design',
    cubesFootbridgeTitle: 'Cubes of Growth',
    cubesFootbridgeSubtitle: 'Pedestrian Bridge Design Based on Growth Algorithm',
    fluxorTitle: 'Fluxor',
    fluxorSubtitle: '2040 Shanghai Mobility System',
    ingeniousSkinTitle: 'Ingenious Skin',
    ingeniousSkinSubtitle: 'Natural Interaction Design in Smart Cockpit Based on Smart Textile',
    scienceExhibitionTitle: 'Science Popularization Exhibition',
    scienceExhibitionSubtitle: 'Exhibition Interaction and Visual Design',
    helmetGenerativeTitle: 'Helmet Generative Design',
    helmetGenerativeSubtitle: 'Generative Cycling Helmet Concept',
  },
} as const;
